    ...
    return (
      <div className="flex justify-between px-5 items-center">
        <div className="flex gap-5 items-center mt-3">
          <Skeleton className="w-28 h-14 rounded-sm bg-slate-200" />
          <Skeleton
            placeholder="hello"
              ...
              <Popover>
                <PopoverTrigger>
                  <div className="w-full h-full flex items-center gap-2 cursor-pointer">
                    <div className="w-[32px] h-[32px] border border-[#1A8917]  rounded-full flex items-center justify-center overflow-hidden">
                      {/* {session.user.name && (
...
export default NavbarSuccessAuth;
