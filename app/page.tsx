      ...
      <section>
        <div className="bg-yellow border-b border-dark overflow-hidden">
          <div className="relative">
            <div className="max-w-screen-xl m-auto h-[530px] px-7 md:px-12 flex items-center justify-between ">
              ...
              <div className="hidden absolute -right-32 top-28 lg:right-0 md:block scale-110">
                <Image
                  src={MediumHero}
                  alt="Medium Hero"
                  width={500}
